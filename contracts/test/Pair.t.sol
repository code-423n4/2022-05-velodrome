...
contract PairTest is BaseTest {
    ...
    function deployPairFactoryGauge() public {
        ...
        address bribeAddress2 = voter.bribes(gaugeAddress2);

        address gaugeAddress3 = voter.gauges(address(pair3));
        address bribeAddress3 = voter.bribes(gaugeAddress3);
        ...
        bribe2 = Bribe(bribeAddress2);
        bribe3 = Bribe(bribeAddress3);
    ...
    function gaugePokeHacking2() public {
        ...
        voter.poke(1);
        // TODO figure out why they're equal, should be <
    ...
    function stakingRewardsSenseCheck() public {
